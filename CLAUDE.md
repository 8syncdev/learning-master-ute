...
Nhỏ + dùng cho MỌI task. **Thứ tự = ưu tiên (đọc top-down).** Mở `SKILL.md` ở path dưới rồi mới gọi tool đầu tiên:
  ...
  1. `/home/alexdev/Projects/learning-master-ute/agents/skills/codegraph/SKILL.md`
  2. `/home/alexdev/Projects/learning-master-ute/agents/skills/karpathy-guidelines/SKILL.md`
  3. `/home/alexdev/Projects/learning-master-ute/agents/skills/ponytail/SKILL.md`
  4. `/home/alexdev/Projects/learning-master-ute/agents/skills/8sync-cli/SKILL.md`
...
- `assp-skill` — `/home/alexdev/Projects/learning-master-ute/agents/skills/assp-skill/SKILL.md`
- `impeccable` — `/home/alexdev/Projects/learning-master-ute/agents/skills/impeccable/SKILL.md`
- `design-taste-frontend` — `/home/alexdev/Projects/learning-master-ute/agents/skills/taste-skill/SKILL.md`
- `image-routing` — `/home/alexdev/Projects/learning-master-ute/agents/skills/image-routing/SKILL.md`
